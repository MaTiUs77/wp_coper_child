...
if(td_util::get_option('tds_search_placement') == '') { ?>
    <div class="header-search-wrap">
        <div class="td-search-btns-wrap">
            ...
            <li><a id="td-header-nightmode-button" class="nightmode_btn" href="#" role="button" data-toggle="dropdown"><img src="<?php echo get_stylesheet_directory_uri() . '/images/nightmode.png'; ?>"></a></li>
        </ul>
        </div>
